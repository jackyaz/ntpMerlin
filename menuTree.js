...
tab: [
{url: "Guest_network.asp", tabName: "<#194#>"},
{url: "Captive_Portal.asp", tabName: "Free Wi-Fi"},
{url: "Captive_Portal_Advanced.asp", tabName: "<#3200#>"},
...
{url: "AiProtection_HomeProtection.asp", tabName: "<#950#>"},
{url: "AiProtection_MaliciousSitesBlocking.asp", tabName: "<#993#>"},
{url: "AiProtection_IntrusionPreventionSystem.asp", tabName: "<#1008#>"},
{url: "AiProtection_InfectedDevicePreventBlock.asp", tabName: "<#912#>"},
{url: "AiProtection_WebProtector.asp", tabName: "<#355#>"},
...
{url: "YandexDNS.asp", tabName: "<#3156#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
...
index: "menu_QoS",
tab: [
{url: "QoS_EZQoS.asp", tabName: "<#2038#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#651#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#2489#>"},
...
tab: [
{url: "ParentalControl.asp", tabName: "<#355#>"},
{url: "YandexDNS.asp", tabName: "<#3156#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
...
tab: [
{url: "AdaptiveQoS_Bandwidth_Monitor.asp", tabName: "<#1114#>"},
{url: "QoS_EZQoS.asp", tabName: "<#2038#>"},
{url: "QoS_Stats.asp", tabName: "Classification"},
{url: "AdaptiveQoS_WebHistory.asp", tabName: "<#754#>"},
{url: "AdaptiveQoS_ROG.asp", tabName: "<table style='margin-top:-7px;'><tr><td><img src='/images/ROG_Logo.png' style='border:0px;width:32px;'></td><td>ROG First</td></tr></table>"},
{url: "Main_Spectrum_Content.asp", tabName: "<#2489#>"},
{url: "Advanced_QOSUserPrio_Content.asp", tabName: "__INHERIT__"},
{url: "Advanced_QOSUserRules_Content.asp", tabName: "__INHERIT__"},
...
{url: "TrafficAnalyzer_Statistic.asp", tabName: "<#2496#>"},
{url: "AdaptiveQoS_TrafficLimiter.asp", tabName: "Traffic Limiter"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
...
tab: [
{url: "GameBoost.asp", tabName: "<#1683#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "mediaserver.asp", tabName: "<#655#>"},
{url: "Advanced_AiDisk_samba.asp", tabName: "<#289#>".concat(WebDav_support?" / <#1219#>":"")},
{url: "Advanced_AiDisk_NFS.asp", tabName: "NFS Exports"},
{url: "Advanced_AiDisk_ftp.asp", tabName: "<#290#>"},
...
{url: "cloud_sync.asp", tabName: "<#2480#>"},
{url: "cloud_router_sync.asp", tabName: "<#2420#>"},
{url: "cloud_settings.asp", tabName: "<#2439#>"},
{url: "cloud_syslog.asp", tabName: "<#2004#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Feedback_Info.asp", tabName: "NTP Daemon"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
index: "menu_Wireless",
tab: [
{url: "Advanced_Wireless_Content.asp", tabName: "<#272#>"},
{url: "Advanced_WWPS_Content.asp", tabName: "<#273#>"},
{url: "Advanced_WMode_Content.asp", tabName: "WDS"},
{url: "Advanced_ACL_Content.asp", tabName: "<#275#>"},
{url: "Advanced_WSecurity_Content.asp", tabName: "<#276#>"},
{url: "Advanced_WAdvanced_Content.asp", tabName: "<#277#>"},
{url: "Advanced_WProxy_Content.asp", tabName: "<#2948#>"},
{url: "Advanced_Roaming_Block_Content.asp", tabName: "<#2951#>"},
{url: "Advanced_Wireless_Survey.asp", tabName: "Site Survey"},
{url: "WiFi_Insight.asp", tabName: "<#2949#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_LAN",
tab: [
{url: "Advanced_LAN_Content.asp", tabName: "<#279#>"},
{url: "Advanced_DHCP_Content.asp", tabName: "<#280#>"},
{url: "DNSFilter.asp", tabName: "DNSFilter"},
{url: "Advanced_MultiSubnet_Content.asp", tabName: "<#280#>"},
{url: "Advanced_GWStaticRoute_Content.asp", tabName: "<#281#>"},
{url: "Advanced_IPTV_Content.asp", tabName: "IPTV"},
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#2520#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_WAN",
tab: [
{url: "Advanced_WAN_Content.asp", tabName: "<#283#>"},
{url: "Advanced_DSL_Content.asp", tabName: "<#283#>"},
{url: "Advanced_VDSL_Content.asp", tabName: "<#283#>"},
{url: "Advanced_Modem_Content.asp", tabName: "<#283#>"},
{url: "Advanced_MobileBroadband_Content.asp", tabName: "<#283#>"},
{url: "Advanced_WANPort_Content.asp", tabName: "<#168#>"},
{url: "Advanced_PortTrigger_Content.asp", tabName: "<#284#>"},
{url: "Advanced_VirtualServer_Content.asp", tabName: "<#285#>"},
{url: "Advanced_Exposed_Content.asp", tabName: "<#286#>"},
{url: "Advanced_ASUSDDNS_Content.asp", tabName: "<#287#>"},
{url: "Advanced_NATPassThrough_Content.asp", tabName: "<#315#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_VPN_OpenVPN.asp", tabName: "<#126#>"},
{url: "Advanced_VPN_PPTP.asp", tabName: "__INHERIT__"},
{url: "Advanced_VPN_IPSec.asp", tabName: "__INHERIT__"},
{url: "Advanced_OpenVPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#3293#>" : "<#2912#>"},
...
index: "menu_Firewall",
tab: [
{url: "Advanced_BasicFirewall_Content.asp", tabName: "<#272#>"},
{url: "Advanced_URLFilter_Content.asp", tabName: "<#294#>"},
{url: "Advanced_KeywordFilter_Content.asp", tabName: "<#297#>"},
{url: "Advanced_Firewall_Content.asp", tabName: "<#296#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Setting",
tab: [
{url: "Advanced_OperationMode_Content.asp", tabName: "<#300#>"},
{url: "Advanced_System_Content.asp", tabName: "<#302#>"},
{url: "Advanced_FirmwareUpgrade_Content.asp", tabName: "<#303#>"},
{url: "Advanced_SettingBackup_Content.asp", tabName: "<#304#>"},
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "Temperature"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#266#>"},
{url: "Advanced_Feedback.asp", tabName: "<#2033#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#3324#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Log",
tab: [
{url: "Main_LogStatus_Content.asp", tabName: "<#305#>"},
{url: "Main_WStatus_Content.asp", tabName: "<#307#>"},
{url: "Main_DHCPStatus_Content.asp", tabName: "<#306#>"},
{url: "Main_IPV6Status_Content.asp", tabName: "IPv6"},
{url: "Main_RouteStatus_Content.asp", tabName: "<#309#>"},
{url: "Main_IPTStatus_Content.asp", tabName: "<#308#>"},
{url: "Main_AdslStatus_Content.asp", tabName: "<#265#>"},
{url: "Main_ConnStatus_Content.asp", tabName: "<#1242#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2156#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2176#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#2473#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
